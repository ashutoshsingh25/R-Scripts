df<-readxl::read_excel("C:/Users/Imart/Desktop/ISQ Audit data/Custom ISQ corpus data.xlsx",sheet = 1)# Path of excel containing, MCAT ID and their corresponding labels
...
for(i in 1:length(out)){
  ...
  location<-paste0("wtpisq/",hold,".txt")
  location<-paste0("E:/",location)
...
for(i in 1:length(out))
{
  ...
  location<-paste0("E:/Data/",location)
  for(j in 1:a)
  {

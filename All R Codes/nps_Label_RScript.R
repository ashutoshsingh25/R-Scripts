...
MCAT_Training_PATH <- paste0("C:/Users/imart/Desktop/Excavator_nps/MCAT/")
PMCAT_Testing_PATH <- paste0("C:/Users/imart/Desktop/Excavator_nps/PMCAT/")
Kfold_PATH <- paste0("C:/Users/imart/Desktop/Excavator_nps/KFOLD/")
...
df1 <- df[,c("PRIME_MCAT_ID","PMCAT2","PMCAT ID","OTHER_MCATS","Other_PMCAT_ID","PRIME_MCAT_NAME","PC_ITEM_ID","PC_ITEM_NAME","PC_ITEM_DESC_SMALL","FK_IM_SPEC_MASTER_DESC","FK_IM_SPEC_OPTIONS_DESC","Label","Label1")]
#df1 <- df[,c(1:5,8,9)]
#fix(df)
#df2 <- df1[1:2000,]
...
data_unique$PMCAT_C <- paste0(data_unique$PMCAT_C,"_",data_unique$`PMCAT ID`)
data_unique$PRIME_MCAT_NAME1 <- paste0("__label__p_",data_unique$PRIME_MCAT_NAME1)
data_unique$OTHER_MCATS1 <- paste0("__label__s_",data_unique$OTHER_MCATS1,"_",data_unique$Other_PMCAT_ID)
data_unique$PMCAT_C <- paste0("__label__pp_",data_unique$PMCAT_C)
...
write.table(data_unique$FASTTEXT_LABEL,"c:/Users/imart/Desktop/nps_leveleed_with_ids.txt",row.names = F,col.names = F,quote = F)

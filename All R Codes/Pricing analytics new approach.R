#load Data
load("E:/Pricing Analytics/SubCatData.RData")
...
data<-sqldf(query)
write.xlsx(data,"E:/Pricing Analytics/check.xlsx")
write.csv(data,"E:/Pricing Analytics/units_final.csv")
...
write.xlsx(stats,"E:/Pricing Analytics/Final_Data.xlsx",row.names = F)

...
Data_3yr <- read.csv("E:/Pricing_analytics/3 yrs/RawDataToColumns.csv",header = T)
...
AOV_3yr <- read.csv("C:/Users/Imart/Downloads/aov_3years (1).csv",header = T)
uniq_aov <- unique(AOV_3yr$AOV_VAL)

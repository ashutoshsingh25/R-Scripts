...
remaining<-dir("C:/Users/Imart/Desktop/QUESTION/Inverter/outfiles/")
...
{
  # Read CSV one by one
  tot_files<-paste0("C:/Users/Imart/Desktop/QUESTION/Inverter/outfiles/",id[j])
...
colnames(master_Data)[names(master_Data) == "Id"] <- "MCAT ID"
master_Data <- master_Data[,c("Label","MCAT ID","Keyword","best1","prediction1","best2","prediction2")]
write.xlsx(master_Data,file = "C:/Users/Imart/Desktop/QUESTION/Inverter/Inverter_output.xlsx",row.names = FALSE)
